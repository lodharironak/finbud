...
jQuery(document).ready(function(e){
    jQuery('ul.tt-tabs-list li.tt-tabs').click(function(e){
        var id = jQuery(this).data('tabspanel');
        console.log(id);
        jQuery('.tt-tabs').removeClass('tt-tabs-active');
        jQuery(this).addClass('tt-tabs-active');

        jQuery('.template-body').removeClass('tt-panel-active');
        jQuery('#'+id).addClass('tt-panel-active');
    });
});