...
class RM_Field_Factory {
    ...
    public function create_privacy_field(){
        ...
        $html= "<div class='rmrow rm-privacy-row rm-full-width $class'><span class='rm-privacy-checkbox'>$checkbox</span>$content</div> <div class='rm-form-error-message rm-form-field-invalid-msg'><span class='rm-error-navigation-message'>This field is required.</span><span class='rm-form-error-arrow'></span></div>";
