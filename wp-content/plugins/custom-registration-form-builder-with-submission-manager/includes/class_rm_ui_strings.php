    ...
    public static function get($identifier) {
        ...
        switch ($identifier) {
            ...
            case 'ADMIN_MENU_FORM_STATS':
                  return __("Analytics <span class='dashicons dashicons-arrow-right-alt2'></span> <span class='rm-sub-muenu-text'>FORMS</span>", 'custom-registration-form-builder-with-submission-manager');

            case 'ADMIN_MENU_FIELD_STATS':
                  return __("Analytics <span class='dashicons dashicons-arrow-right-alt2'></span><span class='rm-sub-muenu-text'> FIELDS</span>", 'custom-registration-form-builder-with-submission-manager');
