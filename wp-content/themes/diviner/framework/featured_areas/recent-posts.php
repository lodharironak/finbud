...
<div class="featposts fp-thumb">
        ...
        $params = array( 'posts_per_page' =>  $post_count, 'ignore_sticky_posts' => true );
                    ...
                    <?php
                     ...
                     ?>
                         ...
                         <div class="fp_title col">
                             ...
                             <div class="fp_time_ago">
                                 <?php echo diviner_time_ago(); ?>
                             </div>
                         </div>
                     ...
                     ?>
                        ...
                        <div class="fp_title col-9">
                            <h4 class="title-font" title="<?php the_title_attribute(); ?>">
                                <a href="<?php the_permalink(); ?>" title="<?php the_title_attribute(); ?>" tabindex="0"><?php the_title(); ?></a>
                            </h4>
