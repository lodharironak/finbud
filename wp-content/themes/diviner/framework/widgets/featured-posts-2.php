...
function diviner_fp_grid_2_widget() {
    register_widget( 'diviner_fp_grid_2' );
}
add_action( 'widgets_init', 'diviner_fp_grid_2_widget' );

// Creating the widget
class diviner_fp_grid_2 extends WP_Widget {
...
// Widget name will appear in UI
            esc_html__('D - Featured Posts 2 x 2 (Thumb)', 'diviner'),

// Widget description
            array( 'description' => esc_html__( 'This Widget will show posts in a 2 Column Thumb Grid.', 'diviner' ), )
        );
    }
