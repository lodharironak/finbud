...
function diviner_fp_grid_slider_widget() {
    register_widget( 'diviner_fp_grid_slider' );
}
add_action( 'widgets_init', 'diviner_fp_grid_slider_widget' );

// Creating the widget
class diviner_fp_grid_slider extends WP_Widget {

    function __construct() {
        parent::__construct(

// Base ID of your widget
            'diviner_fp_grid_slider',

// Widget name will appear in UI
            esc_html__('D - Slider + Featured Posts', 'diviner'),
