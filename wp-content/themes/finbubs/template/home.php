         ...
         <div class="container">
            ...
            <div class="blog-inner">
               ...
               <div class="blog-third">
                  <div class="blog-content">
                        <?php 
                        if(!empty($lastest_news)){
                           $image = wp_get_attachment_image_src( get_post_thumbnail_id( $lastest_news->ID ), 'single-post-thumbnail' );?>
                           <div class="blog-img">
            ...
            <div class="blog-btn text-center"> 
               <?php 
                  ...
                  if ($btn && is_array($btn)) {
                     $link_url = isset($btn['url']) ? esc_url($btn['url']) : '';
                     $link_target = isset($btn['target']) ? esc_attr($btn['target']) : '';
                     $link_title = isset($btn['title']) ? $btn['title'] : '';
               ?>
               <a class="btn btn-transparent" href="<?php echo esc_url(get_permalink()); ?>" target="<?php echo esc_attr($link_target); ?>">
                  <?php esc_html_e('View All News', 'finbubs'); ?><i class="fa fa-angle-double-right" aria-hidden="true"></i>
               </a>
               <?php } ?>
            </div>
         </div>
