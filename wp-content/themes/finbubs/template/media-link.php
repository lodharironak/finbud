...
require_once '/opt/lampp/htdocs/finbud/wp-content/plugins/custom-facebook-feed/inc/CFF_Utils.php';
require_once '/opt/lampp/htdocs/finbud/wp-content/plugins/custom-facebook-feed/inc/CFF_Shortcode_Display.php';
...
if( $cff_show_media_link && ($cff_post_type == 'photo' || $cff_post_type == 'video' || $cff_album) ):
	...
	$churl = str_replace("100175212939194","Iflair-Technological-Pvt-Ltd/","https://www.facebook.com/Iflair-Technological-Pvt-Ltd-100175212939194");
?>
<p class="cff-media-link"> 
	<a href="<?php echo esc_url($churl) ?>" <?php echo $target; ?> style="color: #<?php echo $cff_posttext_link_color ?>">
